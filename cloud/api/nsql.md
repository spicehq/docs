...
{% hint style="warning" %}
This endpoint requires Spice runtime **v2.1.0 or later**. Apps pinned to an earlier version return `404`. See [Spice Runtime Versions](https://docs.spice.ai/docs/portal/app-spicepod/spice-runtime-versions).
{% endhint %}
...
Both endpoints have an interactive console in the Playground under **APIs** — **NSQL** and **NSQL Context**. The NSQL Context console builds the request from the options above and shows the returned block. See [Playground](https://docs.spice.ai/docs/portal/playground).

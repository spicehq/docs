...
Spice Cloud can be monitored with Datadog using the [Metrics endpoint](/api/runtime-apis/metrics) and a pre-built dashboard available in the [Spice repository](https://github.com/spiceai/spiceai/blob/trunk/monitoring/datadog-dashboard.json).
